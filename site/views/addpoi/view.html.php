 ...
 */
class VirtualcitytourViewAddpoi extends JView
{
	protected $script;
	protected $state;
	protected $item;
	...
	protected function setDocument() 
	{
		...
		$ie  = '<!--[if lt IE 9]>' . "\n";
		$ie .= '<link rel="stylesheet" href="'.JURI::root(true).'/components/com_virtualcitytour/css/ie.css'.'">' . "\n";
		$ie .= '<![endif]-->' . "\n";
		...
		//$document->addScript(JURI::root() . "/components/com_virtualcitytour/views/addpoi/submitbutton.js");
