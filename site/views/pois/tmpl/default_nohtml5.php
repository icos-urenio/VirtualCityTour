	...
	<div id="imc-header">
		<div id="imc-menu" class="poislist">
			...
			<div class="btn-group imc-right">
				<a class="btn btn-large btn-primary" href="<?php echo VirtualcitytourHelper::generateRouteLink('index.php?option=com_virtualcitytour&task=addPoi');?>"><i class="icon-plus icon-white"></i> <?php echo JText::_('REPORT_AN_POI');?></a>
			</div>
