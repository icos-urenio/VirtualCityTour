...
class VirtualcitytourViewPoi extends JView
{
	...
	protected function setDocument() 
	{
		...
		$document->addStyleSheet(JURI::root(true).'/components/com_virtualcitytour/css/virtualcitytour_print.css');	
		$document->addStyleSheet(JURI::root(true).'/components/com_virtualcitytour/css/print.css', 'text/css', 'print');	
		...
		//$document->addScript(JURI::root(true).'/components/com_virtualcitytour/js/jquery-ui.min.js');
