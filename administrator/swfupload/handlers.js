...
function addNewImage(path, thumbpath, filename) {
	...
	myRequest.send('option=com_virtualcitytour&controller=VirtualcitytourController&task=prepareImages&format=raw'+'&id='+id);
}
...
function deleteImage(path, filename) {
	...
	if(confirm("Θέλετε να διαγράψετε την φωτογραφία;")){
		...
		myRequest.send('option=com_virtualcitytour&controller=VirtualcitytourController&task=deleteImage&format=raw&filename='+filename+'&id='+id);
	}
}
...
function addNewPanorama(path, thumbpath, filename) {
	...
	myRequest.send('option=com_virtualcitytour&controller=VirtualcitytourController&task=preparePanoramas&format=raw'+'&id='+id);
}
...
function deletePanorama(path, filename) {
	...
	if(confirm("Θέλετε να διαγράψετε το πανόραμα;")){
		...
		myRequest.send('option=com_virtualcitytour&controller=VirtualcitytourController&task=deletePanorama&format=raw&filename='+filename+'&id='+id);
	}
}