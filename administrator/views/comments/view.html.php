 ...
 */
class VirtualcitytourViewComments extends JView
{
	protected $items;
	...
	protected function addToolbar()
	{
		...
		$canDo	= VirtualcitytourHelper::getActions($state->get('filter.virtualcitytourid'));

		JToolBarHelper::title(JText::_('COM_VIRTUALCITYTOUR_TITLE_COMMENTS'), 'items.png');
