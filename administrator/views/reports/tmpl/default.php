...
<table class="adminlist">
  <thead>
    <tr>
      <th>#</th>
      <th><?php echo JText::_('COM_VIRTUALCITYTOUR_VIRTUALCITYTOUR_FIELD_TITLE_LABEL');?></th>
      <th><?php echo JText::_('COM_VIRTUALCITYTOUR_VIRTUALCITYTOUR_FIELD_CATID_LABEL');?></th>
      <th><?php echo JText::_('COM_VIRTUALCITYTOUR_VIRTUALCITYTOUR_FIELD_LATITUDE_LABEL');?></th>
      <th><?php echo JText::_('COM_VIRTUALCITYTOUR_VIRTUALCITYTOUR_FIELD_LONGITUDE_LABEL');?></th>
      <th><?php echo JText::_('COM_VIRTUALCITYTOUR_VIRTUALCITYTOUR_FIELD_ADDRESS_LABEL');?></th>
      <th><?php echo JText::_('COM_VIRTUALCITYTOUR_VIRTUALCITYTOUR_FIELD_CURRENTSTATUS_LABEL');?></th>
