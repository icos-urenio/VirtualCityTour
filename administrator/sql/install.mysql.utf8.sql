...
CREATE TABLE IF NOT EXISTS `#__virtualcitytour` (
...
CREATE TABLE IF NOT EXISTS `#__virtualcitytour_progress` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `virtualcitytourid` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `#__virtualcitytour_votes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `virtualcitytourid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `#__virtualcitytour_comments` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `virtualcitytourid` int(11) NOT NULL,
  `userid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `#__virtualcitytour_timestamp` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `#__virtualcitytour_timestamp` (`triggered`) VALUES (MD5(RAND()));
INSERT INTO `#__virtualcitytour_timestamp` (`triggered`) VALUES (MD5(RAND()));

CREATE TABLE IF NOT EXISTS `#__virtualcitytour_keys` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `skey` varchar(16) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=0 ;

INSERT INTO `#__virtualcitytour_keys` (`skey`) VALUES ('1234567890123456');