 ...
 */
class VirtualcitytourModelComments extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		$query->select(
			$this->getState(
				'list.select',
				'a.*, #__virtualcitytour.title as poititle, #__users.name as user'
			)
		);
		$query->from('`#__virtualcitytour_comments` AS a');
		$query->leftJoin('#__virtualcitytour on virtualcitytourid=#__virtualcitytour.id');
